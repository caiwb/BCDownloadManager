...
- (void)viewDidLoad
{
    ...
    {
        _downloadTask = [[BCDownloadOperation alloc] initWithRequest:[[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:@"http://stream.youdao.com/private/xuetang/pushstation.1477_1_3_screen_2016_02_20_12_07_08.mp4"]] HTTPHeaders:@{@"Referer": @"http://live.youdao.com"} targetPath:[targetPath stringByAppendingString:@"/fileName.mp4"] shouldResume:YES];
        
        [[BCDownloadManager sharedManager] addOperation:_downloadTask];
    }
    [self addObserver:_downloadTask forKeyPath:@"downloadedBytes" options:0 context:nil];
    
}

- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    NSLog(@"%lld",_downloadTask.downloadedBytes);
}
